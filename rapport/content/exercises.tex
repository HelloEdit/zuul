...
On va implémenter la commande \verb|back| de façon très naïve : on rajoute un attribut \verb|aPreviousRoom| dans \verb|GameEngine| qui contiendra la salle qui précedait, dans le parcours du joueur, la salle actuelle.
...
En voyant l'implémentation de la commande \verb|back|, le cas singulier de la salle initiale saute aux yeux : en effet, si l'on a pas encore bougé, \verb|aPreviousRoom| est évalué à \verb|null|, pouvant ammener à un \verb|NullPointerException|. On modifie l'implémentation de \verb|back|.
