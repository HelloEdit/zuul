...
On crée donc une nouvelle commande \verb|test| dont le but est de charger un scénario (spécifié en second mot) et de l'exécuter dans l'interface. Pour ce faire, on crée la méthode test de la façon suivante :
