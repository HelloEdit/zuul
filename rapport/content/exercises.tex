...
\textbf{Note :} J'ai, pour l'instant, décider de ne pas implémenter le modèle MVC dans mon projet Zuul. En effet, je préfère m'intéresser à comment je vais restructurer l'interface graphique avec JavaFX (voir Appendix) avant de changer les détails d'implémentation.

\subsection*{Image}

On en profiter pour déplacer les images de la racine vers un nouveau dossier \verb|Images|.
