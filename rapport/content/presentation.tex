...
\textbf{Note :} Le Narrateur n'a pas été incorporé à cette version du jeu en raison du problème des dialogue.
...
\textbf{IMPORTANT :} Avec BLueJ, il faut compiler "à la main" le fichier \code{ZuulController.java} se trouvant dans le pacquet \code{zuul.pkg_ui.pkg_javafx}.
